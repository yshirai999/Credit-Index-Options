%% Analytical solution of PIDE pricing forward receiver CDX
% risk free rate based discounting of option payoff
function [PI] = CDXPIDE(t,T0,r,lambda,T,kappa,delta,U,...
...
if Protection == 1
    FEP = EFEP(t,T0,r,lambda,delta,U,theta_r,theta_l,rho,c_r,c_l,g_r,g_l,N,L);
else
    FEP = 0;
end

TT = T-[T0,T(1:end-1)];
PI = kappa*hvec*TT'-delta*(gvec-hvec)*Id_M-FEP;
end
