function [R] = RfunLin(r,lambda,uu,Y_r,Y_t,w,Nsim,rho,g_r,g_t,c_r,c_t,N,L)
...
for d=N-2:-1:-N+2 %we construct each diagonal of matrix R_r
    ...
    u_r = interp1(sqrt(1+rho^2)*r(imin:imax)',ud,sqrt(1+rho^2)*RR,'linear','extrap'); % matrix of size as RR
